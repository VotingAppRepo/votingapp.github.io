...
export const userInfoRequest = () => ({
    type: AuthTypes.USER_INFO_REQUEST
})
export const userInfoSuccess = (message) => ({
    type: AuthTypes.USER_INFO_SUCCESS,
    payload: message
})
export const userInfoFailure = (message) => ({
    type: AuthTypes.USER_INFO_FAILURE,
    payload: message
})